    ...
    return (
        <>
            <W.mainLayout>
                <Header></Header>
                <W.writing>
                    <W.fileInput type="file" accept="image/*" ref={fileInputRef} onChange={handleFileChange} />
                    ...
                    <W.writeTitle type="text" placeholder="제목을 입력해주세요"></W.writeTitle>
                    <W.writeDetail type="text" placeholder="내용을 입력해주세요"></W.writeDetail>
                    <W.uploadButton type="submit">
